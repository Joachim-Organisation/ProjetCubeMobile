 ...
 */
class ListSubjectByCategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =
            inflater.inflate(R.layout.fragment_list_subject_by_category_list, container, false)
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int) =
            ListSubjectByCategoryFragment().apply {
